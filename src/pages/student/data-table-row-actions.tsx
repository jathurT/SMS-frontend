...
import StudentDeleteForm from "@/components/forms/student-delete-form";
...
export function DataTableRowActions<TData extends WithId<string>>({
  ...
  return (
    <>
      ...
      >
        <StudentEditForm studentId={studentId} setIsOpen={setIsEditOpen} />
      </ResponsiveDialog>
      <StudentDeleteForm
        studentId={studentId}
        isOpen={isDeleteOpen}
...
export const useRowNavigation = (studentId: number) => {
  const navigate = useNavigate();
